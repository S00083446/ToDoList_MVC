...
namespace ToDoList.DataAccess.Migrations
{
    ...
    [Migration("20220624122350_addedMoreDetailsTblToDb")]
    partial class addedMoreDetailsTblToDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToDoListModels.MoreDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoListModels.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ToDoListModels.MoreDetails", b =>
                {
                    b.HasOne("ToDoListModels.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ToDoListModels.Detail", "Detail")
                        .WithMany()
